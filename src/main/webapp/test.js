$(document).ready(function () {
    ...
    ws.onmessage = function (event) {
        ...
        $("#printerStatus").text(jsonObject.printerStatus.statusValue);
        $("#printerReason").text(jsonObject.printerStatus.shortDescription + " " + jsonObject.paramDescription);
        $("#printerTemperature").text(jsonObject.printerStatus.temperature + "℃");
